 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://trab/", wsdlLocation = "http://erebus:8080/Trabalho4/ServerService?wsdl")
public class ServerService extends Service {
	...
	private final static QName SERVERSERVICE_QNAME = new QName("http://trab/", "ServerService");

	static {
		URL url = null;
		WebServiceException e = null;
		try {
			url = new URL("http://erebus:8080/Trabalho4/ServerService?wsdl");
	...
	public Server getServerPort() {
		return super.getPort(new QName("http://trab/", "ServerPort"), Server.class);
	}
	...
	public Server getServerPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://trab/", "ServerPort"), Server.class, features);
	}
