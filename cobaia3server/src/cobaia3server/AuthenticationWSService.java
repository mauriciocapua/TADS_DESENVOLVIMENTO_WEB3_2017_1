 ...
 * 
 */
@WebServiceClient(name = "AuthenticationWSService", targetNamespace = "http://cobaia3server/", wsdlLocation = "http://erebus:8080/cobaia3server/AuthenticationWSService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://erebus:8080/cobaia3server/AuthenticationWSService?wsdl");
