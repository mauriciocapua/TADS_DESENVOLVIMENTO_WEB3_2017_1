 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://WebServices/}lugar" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ListaLugaresResponse {
     ...
     * 
     */
    public List<Lugar> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Lugar>();
        }
        return this._return;
    }
